 ...
 * полученного как параметр, в том же порядке. Но есть один нюанс. В списке могут быть элементы,
 равные null.
 *
 ...
 * Требования:
 * •	В публичном статическом методе printList(List<String>) нужно вызывать метод orElse()
