...
/**
 * В классе Map3 объявлено поле grades типа HashMap<String, Double>,
 ...
 * Андрей Петров : 4.5
 * Требования:
 * •	В классе Map3 должно быть проинициализированное публичное статическое поле
 grades типа HashMap<String, Double>.
