...
/**
 * В классе Set4 есть методы printHashSet(HashSet<String>) и printList(ArrayList<String>),
 ...
 * Требования:
 * •	В классе Set4 должен быть публичный статический метод printHashSet(HashSet<String>)
 с типом возвращаемого значения void.
 * •	В классе Set4 должен быть публичный статический метод printList(ArrayList<String>)
 с типом возвращаемого значения void.
